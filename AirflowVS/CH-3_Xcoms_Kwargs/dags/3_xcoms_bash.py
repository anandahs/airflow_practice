...
@dag(dag_id="xcom_bash", schedule=None, start_date=None, catchup=False)
def xcoms_bash():
    ...
    def bash_task_with_xcom():
        return "echo 'This is a bash task with XCom data: {{ ti.xcom_pull(task_ids=\"fetch_data\", key=\"fetched_data\") }}'"   
...
xcoms_bash_instance = xcoms_bash()