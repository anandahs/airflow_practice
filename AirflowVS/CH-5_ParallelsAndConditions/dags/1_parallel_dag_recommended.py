...
@dag(dag_id="parallel_recommended_dag", schedule=None, start_date=pendulum.datetime(year=2026, month=6, day=15), catchup=False, is_paused_upon_creation=False)
def parallel_recommended_dag():
...
parallel_dag_recommended_instance = parallel_recommended_dag()