...
@dag(dag_id="conditional_dag", schedule=None, start_date=pendulum.datetime(year=2026, month=6, day=15), catchup=False, is_paused_upon_creation=False)
def conditional_dag():
    ...
    task_bash >> [api_data, db_data, s3_data ] >> process_data() >> decide_branch() >> [s3_load_task(), glue_task()]

conditional_dag_instance = conditional_dag()